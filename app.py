...
<div class="main-header">
    ...
    <p>Tác giả: Mã Trung Thuận - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0967462525</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Mã Trung Thuận - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0967462525</div>", unsafe_allow_html=True)
